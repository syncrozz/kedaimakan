  ...
  public static async createOrGetKitchenTicket(
    ...
    const snapshotItems: KitchenOrderItemSnapshot[] = orderData.items.map((it) => {
      ...
      return {
        ...
        variant: it.selectedModifiers && it.selectedModifiers.length > 0 ? it.selectedModifiers[0].optionName : undefined,
    ...
    for (const newItem of newItems) {
      ...
      if (!existing) {
        ...
        updatedItemsList.push({
          ...
          previousQuantity: 0,
          variant: newItem.selectedModifiers && newItem.selectedModifiers.length > 0 ? newItem.selectedModifiers[0].optionName : undefined,
          modifiers: modifiers.length > 0 ? modifiers : undefined,
